...
def pilih_super():
	...
	def main(arg):
		...
		try:													
			a = requests.get('https://graph.facebook.com/'+user+'/?access_token='+['access_toket'])												
			b = json.loads(a.text)												
			pass1 = b['email']											
